...
OBJ_DEBUG = $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/src/Application.o $(OBJDIR_DEBUG)/src/Menu.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/src/Application.o $(OBJDIR_RELEASE)/src/Menu.o
